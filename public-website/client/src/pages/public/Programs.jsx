...
{/* ================= 1. ASYMMETRIC PREMIUM HERO SECTION ================= */}
      <section className="relative min-h-[70vh] flex items-center bg-white overflow-hidden border-b border-neutral-100 py-16 lg:py-1">
        ...
        <div className="absolute top-1/4 left-0 w-[500px] h-[500px] bg-gradient-to-tr from-accent-50/30 to-info-bg/20 rounded-full blur-3xl pointer-events-none -z-10" />
        <div className="absolute bottom-0 right-0 w-[600px] h-[400px] bg-gradient-to-bl from-neutral-100 via-accent-50/10 to-transparent rounded-full blur-3xl pointer-events-none -z-10" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full relative z-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-start">
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              <div className="inline-flex items-center gap-2 px-3.5 py-1.5 text-[11px] font-bold tracking-wider uppercase te-mono bg-neutral-50 border border-neutral-200/70 text-neutral-900 rounded-full shadow-xs select-none">
              ...
              <h1 className="te-display text-4xl sm:text-5xl lg:text-6xl font-black tracking-tight text-primary-900 leading-[1.12]">
              ...
              <div className="hidden sm:flex items-center gap-4 pt-4 text-neutral-300">
            ...
            <div className="lg:col-span-5 lg:pt-10 space-y-8">
              ...
              <p className="te-body text-neutral-600 text-sm sm:text-base font-normal leading-relaxed border-l-2 border-accent-500/40 pl-4">
          ...
          <div className="flex flex-nowrap overflow-x-auto pb-2 sm:pb-0 sm:justify-center gap-2 scrollbar-none">
            {[
              ...
              <button
                ...
                className={`px-4 py-1.5 rounded-lg text-xs font-bold whitespace-nowrap cursor-pointer transition-all border ${
                  activeTab === tab.id
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {loading ? (
            <p className="text-center py-16 text-sm text-neutral-500">Loading courses...</p>
          ) : error ? (
            <p className="text-center py-16 text-sm text-danger-text">{error}</p>
          ) : filteredTracks.length === 0 ? (
            <div className="text-center py-16 border border-dashed border-neutral-200 rounded-2xl max-w-md mx-auto">
      ...
      <section ref={frameworkRef} className={`py-16 bg-neutral-50/10 border-t border-b border-neutral-50/60 transition-all duration-700 transform ${frameworkAosClass}`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionHeading
