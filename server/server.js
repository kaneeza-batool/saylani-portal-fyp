...
const attendanceScanRoutes = require('./routes/attendanceScanRoutes');
const attendanceRequestRoutes = require('./routes/attendanceRequestRoutes');
const studentAttendanceRequestRoutes = require('./routes/studentAttendanceRequestRoutes');
...
const publicCampusRoutes = require('./routes/publicCampusRoutes');
...
app.use('/api/admin/attendance-scan', attendanceScanRoutes);
app.use('/api/admin/attendance-requests', attendanceRequestRoutes);
app.use('/api/admin/student-attendance-requests', studentAttendanceRequestRoutes);
app.use('/api/admin/student-feedback', studentFeedbackRoutes);
