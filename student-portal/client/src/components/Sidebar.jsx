...
//
// Dashboard, Attendance, and Payment are `courseless` — one course per
// student now (see Student.js/attendanceController/feeController), so those
// three link straight to `base` with no id segment and are never gated on
