        ...
        <div className="max-w-[1000px] mx-auto px-6 py-3.5 flex items-center justify-between">
          <Link to="/donate" className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <div className="text-[10px] text-navy-200 leading-tight">Donor Portal</div>
            </div>
          </Link>
          <div className="flex items-center gap-5">
            <Link to="/donate" className="text-caption font-semibold text-navy-100 hover:text-gold-400 transition-colors">
              All Campaigns
            </Link>
            <Link to="/donate/wall" className="text-caption font-semibold text-navy-100 hover:text-gold-400 transition-colors">
              Donor Wall
            </Link>
            <Link to="/donate/status" className="text-caption font-semibold text-navy-100 hover:text-gold-400 transition-colors">
              Check Status
            </Link>
          </div>
        </div>
